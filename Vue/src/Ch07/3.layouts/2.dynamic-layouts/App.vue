...
/*
const url = shallowRef(window.location.href);
function get_url() {
...
<template>
  <nav style="text-align: center">
    <RouterLink to="/" @click="expand=false">Home</RouterLink>
    |
    <RouterLink to="/update" @click="expand=true">Update</RouterLink>
    |
    <RouterLink to="/switch" @click="expand=true">Switch</RouterLink>
  </nav>
  <br>

  <!--<div v-if="url !== 'http://localhost:5173/'">-->
  <div v-if="expand">
